...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-hackathon-for-hunger/JSONCodable.framework"
  install_framework "Pods-hackathon-for-hunger/NVActivityIndicatorView.framework"
  install_framework "Pods-hackathon-for-hunger/OMGHTTPURLRQ.framework"
  install_framework "Pods-hackathon-for-hunger/ObjectMapper.framework"
  install_framework "Pods-hackathon-for-hunger/PromiseKit.framework"
  ...
  install_framework "Pods-hackathon-for-hunger/SwiftyJSON.framework"
fi
